...
public interface InformationMapper {
	...
	void insertSalary(String username,String year,String month,String jibensalary,String jixiaosalary,String kouQian, String qingJiaDate,String total);//���нˮ��Ϣ
	...
	void insertChuqing(String username,String chuqingtype,String date,String startDate, String endDate,String context,String status,String timeranges);//��ӿ�����Ϣ
