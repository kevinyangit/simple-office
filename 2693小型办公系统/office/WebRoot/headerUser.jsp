  ...
  $("#jlgl").click(function(){
   ...
   $("#fbqz").click(function(){
    if(username==null || username=="" )
        ...
        location.href="views/information/shengqing.jsp";    
  });
   $("#wdkq").click(function(){
    if(username==null || username=="" )
           alert("请先登录！");
    else
        location.href="views/information/chuqing.jsp";    
  });
   $("#myjy").click(function(){
    if(username==null || username=="" )
           alert("请先登录！");
...
<input type="hidden" id="username" value="${sessionScope.username}">
    ...
    <div class="nav layout">
        ...
        <a href="javascript:void(0);" id="fbqz">申请管理</a>
        <a href="javascript:void(0);" id="wdkq">我的考勤</a>
