                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>新闻标题</label><input type="hidden"value="${upList[0]}" id="id">
                                                <input type="text" class="form-control border-input"  placeholder="新闻标题" value="${upList[1]}" id="account">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>作者</label>
                                                <input type="text" class="form-control border-input" placeholder="作者" value="${upList[2]}" id="name">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">发表日期</label>
                                                <input type="text" class="form-control border-input" placeholder="发表日期" value="${upList[3]}" id="pwd">
                                            </div>
                                        </div>
                                    </div>
									<div class="row">
									    <div class="col-md-4">
                                            <div class="form-group">
                                                <label>新闻内容</label>
                                                <textarea rows="10" cols="60" id="age">${upList[4]}</textarea>
                                                <%-- <input type="text" class="form-control border-input" placeholder="新闻内容" value="${upList[4]}" id="age"> --%>
                                            </div>
                                        </div>
									</div>
