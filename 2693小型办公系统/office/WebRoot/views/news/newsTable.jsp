		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">新闻列表</a>
                </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach var="list" items="${findNewsList}">
                                        <tr>
                                        	...
                                        	<button class="btn btn-primary btn-fill " onclick="update(${list.id},'${list.newsname}','${list.author}','${list.date}','${list.context}')">编辑</button>
...
function add(){
    ...
    shade: 0.8,
    area: ['450px', '75%'],
    content: 'views/news/addNews.jsp',
    end: function () {
       location.reload();
    }
});
...
function del(id){
	layer.confirm('确认要删除这条新闻吗？',function(index){
			$.ajax({
				type: 'get',
				url: '${domain }/delNews.do',
				data: {id : id},
...
function update(id,newsname,author,date,context){
	parent.layer.open({
	    type: 2,
	    shadeClose: true,
	    shade: 0.8,
	    area: ['450px', '75%'],
	    content: '${domain }/upNews.do?id='+id+'&newsname='+newsname+'&author='+author+'&date='+date+'&context='+context,
	    end: function () {
