				...
				<div class="card shadow">
					...
					<div class="box1 shadow">
						...
						<input type="text" id="username" name="username"
							readonly="readonly" style="height: 40px; width: 200px;"
						...
						<br>
						工&nbsp;&nbsp;&nbsp;号：
						<input type="text" id="gonghao"
							style="height: 40px; width: 200px;"
							value="${userInfo[0].gonghao }">

						姓&nbsp;&nbsp;&nbsp;名：
						<input type="text" id="name" style="height: 40px; width: 200px;"
							value="${userInfo[0].name }">
						<br>
						<br>
						性&nbsp;&nbsp;&nbsp;别：
						<input type="text" id="sex" style="height: 40px; width: 200px;"
							value="${userInfo[0].sex }">
						年&nbsp;&nbsp;&nbsp;龄：
						<input type="text" id="age" style="height: 40px; width: 200px;"
							value="${userInfo[0].age }">
						<br>
						<br>
						邮&nbsp;&nbsp;&nbsp;箱：
						<input type="text" id="email" style="height: 40px; width: 200px;"
							value="${userInfo[0].email }">
						电&nbsp;&nbsp;&nbsp;话：
						<input type="text" id="phone" style="height: 40px; width: 200px;"
							value="${userInfo[0].phone }">
						<br>
						<br>
						<input type="button" name="submit" value="提交"
							style="height: 40px; width: 50px; margin-left: 45%"
							onClick="update()">
						<!--  <table class="myInfo">
                <tr>
                    <th>姓名：</th>
