                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control border-input" placeholder="密码"  id="pwd">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>工号</label>
                                                <input type="text" class="form-control border-input" placeholder="工号"  id="gonghao">
                                            </div>
                                        </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label>姓名</label>
                                                <input type="text" class="form-control border-input" placeholder="姓名"  id="name">
                                            </div>
                                        </div>
                                         <div class="col-md-5">
                                            <div class="form-group">
                                                <label>性别</label>
                                                <input type="text" class="form-control border-input"  placeholder="性别"  id="sex">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>年龄</label>
                                                <input type="text" class="form-control border-input"  placeholder="年龄"  id="age">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>邮箱</label>
                                                <input type="text" class="form-control border-input"  placeholder="邮箱"  id="email">
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
                                                <label>电话</label>
                                                <input type="text" class="form-control border-input" placeholder="电话"  id="phone">
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
                                                <label>职位</label>
                                                <input type="text" class="form-control border-input" placeholder="职位"  id="status">
                                            </div>
                                        </div>
                                    </div>
