		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">日程列表</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="list" items="${findRcapList}" varStatus="status">
                                        <tr>
                                        	<td>${status.count}</td>
                                        	<td>${list.username}</td>
                                        	<td>${list.time}</td>
...
function add(){
    ...
    shade: 0.8,
    area: ['450px', '75%'],
    content: 'views/admin/addRcap.jsp',
    end: function () {
       location.reload();
    }
});
...
function del(id){
	layer.confirm('确认要删除这条日程吗？',function(index){
			$.ajax({
				type: 'get',
				url: '${domain }/deleteRcap.do',
				data: {id : id},
