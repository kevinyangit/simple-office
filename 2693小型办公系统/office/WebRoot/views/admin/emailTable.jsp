		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">邮件列表</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="list" items="${findEmailList}" varStatus="status">
                                        <tr>
                                        	<td>${status.count}</td>
                                        	<td>${list.fsperson}</td>
                                        	<td>${list.jsperson}</td>
...
function add(){
    ...
    shade: 0.8,
    area: ['450px', '75%'],
    content: 'views/admin/addEmail.jsp',
    end: function () {
       location.reload();
    }
});
...
function del(id){
	layer.confirm('确认要删除该邮件吗？',function(index){
			$.ajax({
				type: 'get',
				url: '${domain }/deleteEmail.do',
				data: {id : id},
