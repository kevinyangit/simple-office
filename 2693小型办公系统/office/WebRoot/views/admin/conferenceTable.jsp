		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">会议列表</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach var="list" items="${findConferenceList}" varStatus="status">
                                        <tr>
                                        	<td>${status.count}</td>
                                        	<td>${list.time}</td>
                                        	<td>${list.location}</td>
...
function add(){
    ...
    shade: 0.8,
    area: ['450px', '75%'],
    content: 'views/admin/addConference.jsp',
    end: function () {
       location.reload();
    }
});
...
function del(id){
	layer.confirm('确认要删除这条会议信息吗？',function(index){
			$.ajax({
				type: 'get',
				url: '${domain }/deleteConference.do',
				data: {id : id},
